...
Risolvono i problemi e prevengono problemi futuri. Includono l'infliggere
una punizione.

\paragraph*{Controlli di rilevamento} (\textit{Detecive Controls}):
Trovano una frode mentre è in corso.
Includono hotline anonime, audit a sorpresa, monitoraggio delle 
attività .

\paragraph*{Controlli preventivi} (\textit{Preventive Controls}):
Prevengono le frodi. Includono: \textit{risk assessment}, sviluppo di 
controlli interni, sicurezza fisica e informatica, autorizzazioni (es. password) e
...
\subsection[Statistiche sulle frodi]{
